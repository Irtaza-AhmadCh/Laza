        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
                      ...
                      return Column(
                        ...
                        children: [
                          ...
                          Consumer<CartAddProductProvider>(
                            builder: (BuildContext context, CartAddProductProvider val, Widget? child) {
                                    ...
                                    children: [
                                      ...
                                      InkWell(
                                        onTap: () {
                                          ...
                                          // value.decreaseCount(productId: widget.ProjectId, quantity: widget.quantity);
                                        },
                                        child: Container(
                                          height: 25,
                                          width: 25,
              ...
              Consumer<CartAddProductProvider>(
    builder: (BuildContext context, CartAddProductProvider val,
    Widget? child) {
                  ...
                  builder: (BuildContext context, CartItemDeleteProvider value,
                    ...
                    return InkWell(
                      onTap: () {
                        print('tap');
                        val.getCart();
                        value.remover(widget.ProjectId);
                      },
                      child: Container(
                        height: 25,
                        width: 25,
